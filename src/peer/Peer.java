...
public class Peer {
    ...
    private static final String PEER_INFO_CONFIGURATION_FILE = "peer.PeerInfo.cfg";
    ...
    public static void main(String[] args) {
        ...
        // peer.Peer connection object to start listening for new connections, send a message to any connection or create a connection to any peer
        ...
        // Connect to peers in peer.PeerInfo.cfg which appear above the current line by parsing the peer info config file again
    ...
    private static void parsePeerInfoConfigToMakeConnections(PeerConnection connection) {
        try {
            ...
            while (linePeerId != myPeerInfo.getPeerID()) {
                ...
                // Log connection
                myPeerInfo.log("peer.Peer [peerID " + myPeerInfo.getPeerID() + "] makes a connection to peer.Peer[peer_ID " + linePeerId + "]");
            ...
            System.err.println("[ERROR]: peer.Peer Info configuration file not found");
            e.printStackTrace();
        } catch (IOException e) {
            System.err.println("[ERROR]: Error parsing peer.Peer Info configuration file");
            e.printStackTrace();
        }
    }
...
//                System.out.println("Tushar debug");
     ...
     *
     * @param peerID peer.Peer ID of the peer whose logger we are setting up
