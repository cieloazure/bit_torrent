...
import message_states.ExpectedToSendHandshakeMessageState;
import message_states.PeerState;
import message_states.WaitForHandshakeMessageState;
import neighbour.NeighbourInputHandler;
import neighbour.NeighbourOutputHandler;
import neighbour.NeighbourPeerInfo;
...
//    private ConcurrentHashMap<Integer, neighbour.NeighbourPeerInfo> neighbourConnectionsInfo;
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    myPeerInfo.log("peer.Peer [peer_ID "+myPeerInfo.getPeerID()+"] is connected from peer.Peer[peer_ID "+theirPeerId+"]");
